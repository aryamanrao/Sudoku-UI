...
function sendNetworkLog(
    ...
    state,
    version) {
  var formid = "1FAIpQLSdF5nhA0yS2bFbOj_4JpelIJWkJQe9xKX3c6RnOiBrpHVAXgg";
  var data = {
    "entry.89925069": uid,
    "entry.775337756": time,
    "entry.1213338168": name,
    "entry.1328722043": target,
    "entry.1428287390": info,
    "entry.1815561206": state,
    "entry.2082731491": version
  };
  var params = [];
  for (key in data) {
